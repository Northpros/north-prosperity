    ...
    <div style={{fontFamily:FONT_BODY,background:T.bg,minHeight:"100vh",padding:"12px 16px",color:T.text,transition:"background 0.3s,color 0.3s"}}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .np-disclaimer{position:fixed;bottom:0;left:0;right:0;z-index:9999;background:#0d0d1f;border-top:1px solid #2a2a4a;padding:6px 16px;text-align:center;}
        .np-disclaimer-text{font-family:'JetBrains Mono','SF Mono',monospace;font-size:10px;color:#555577;line-height:1.6;word-break:break-word;white-space:normal;max-width:100%;display:block;}
      `}</style>

      {/* Permanent Disclaimer Footer */}
      <div className="np-disclaimer">
        <div className="np-disclaimer-text">
          ⚠️ Not financial advice · For educational and simulation purposes only · Past performance does not guarantee future results
        </div>
        <div className="np-disclaimer-text">
          Always consult a qualified financial advisor before making investment decisions · © 2026 North Prosperity
        </div>
      </div>
